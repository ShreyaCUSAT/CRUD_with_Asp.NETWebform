<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cust-form2.aspx.cs" Inherits="Customer_form.Cust_form2" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <div style="margin: 0px 80px 0px 80px;">
                <asp:GridView ID="GridView1" CssClass="gridCSS" runat="server" Style="margin: auto; border: 2px solid; outline: 1px solid;" Width="100%" AutoGenerateColumns="False" DataKeyNames="rollno" BorderStyle="Solid" PageSize="6" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
